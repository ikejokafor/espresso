...
void PoolingLayer::ComputeLayerParam() {
	...
	m_numOutputRows = (int)ceil((m_numInputRows - m_numKernelRows + 2 * m_padding) / m_stride) + 1;
	m_numOutputCols = (int)ceil((m_numInputCols - m_numKernelCols + 2 * m_padding) / m_stride) + 1;
