...
espresso::Layer::Layer(espresso::layerInfo_obj* layerInfo) {
	...
	m_fpga_activation 			= false;
	m_fpga_do_res_layer 		= false;
	m_fpga_do_kernels1x1		= false;
	m_fpga_merged   			= false;
	m_fpga_krnl_1x1_layer		= false;
	m_fpga_do_1x1_res 			= false;
	m_fpga_do_res_1x1 			= false;
	m_sequence_id				= -1;
	m_base_bandwidth			= 0;
	m_opt_bandwidth				= 0;
    m_dilation                  = layerInfo->dilation;
    m_first                     = layerInfo->first;
    m_last                      = layerInfo->last;
}
